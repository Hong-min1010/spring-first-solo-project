...
public class QuestionMapperImpl implements QuestionMapper {
    ...
    public Question questionPostDtoToQuestion(QuestionPostDto questionPostDto) {
        ...
        question.setQuestionContext( questionPostDto.getQuestionContext() );
        question.setQuestionStatus( questionPostDto.getQuestionStatus() );
        question.setQuestionVisibility( questionPostDto.getQuestionVisibility() );
    ...
    public Question questionPatchDtoToQuestion(QuestionPatchDto questionPatchDto) {
        ...
        question.setQuestionContext( questionPatchDto.getQuestionContext() );
        question.setQuestionStatus( questionPatchDto.getQuestionStatus() );
        question.setQuestionVisibility( questionPatchDto.getQuestionVisibility() );
